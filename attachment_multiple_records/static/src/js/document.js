openerp.attachment_multiple_records = function (instance, m) {
    ...
    instance.web.Sidebar.include({
        redraw: function () {
            ...
            self.$el
                .find(".oe_sidebar_add_attachment")
                .after(QWeb.render("AddDocfromserver", {widget: self}));
        ...
        on_call_new_view_function: function (state) {
            ...
            var ids =
                view.fields_view.type != "form"
                    ? view.groups.get_selection().ids
                    : [view.datarecord.id];
        ...
        on_attachment_delete: function (e) {
            ...
            if (confirm(_t("Do you really want to delete this attachment ?"))) {
                new instance.web.DataSet(this, "ir.attachment", context)
        ...
        do_attachement_update: function (dataset, model_id, args) {
            ...
            if (!model_id) {
                ...
                var ds = new instance.web.DataSetSearch(
                    this,
                    "ir.attachment",
                    context,
                    dom
                ...
                ds.read_slice(
                    ...
                    {}
                ).done(this.on_attachments_loaded);
            }
        },
    });
};
